									...
									<nav class="crmny-navigation" data-nav="1199">
										<ul id="menu-main-menu" class="">
											<li id="menu-item-715" class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-715 active">
												<a href="products.php" class="dropdown-toggle" aria-haspopup="true">
													<span class="menu-text"><span class="menu-text-wrap" data-hover="Products">Products</span></span>
												</a>
											</li>
											...
											<li id="menu-item-718" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-718 has-dropdown">
												<a href="my-account.php" class="dropdown-toggle" aria-haspopup="true">
								...
								<div data-elementor-type="wp-post" data-elementor-id="8" class="elementor elementor-8" data-elementor-settings="[]">
									<div class="elementor-inner">
										<div class="elementor-section-wrap">
											<section class="mb-5 elementor-element elementor-element-e49992a elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section" data-id="e49992a" data-element_type="section">
												<div class="elementor-container elementor-column-gap-default">
													<div class="elementor-row">
														<div class="elementor-element elementor-element-2144465 elementor-column elementor-col-100 elementor-top-column" data-id="2144465" data-element_type="column">
															<div class="elementor-column-wrap  elementor-element-populated">
																<div class="elementor-widget-wrap">
																	<div class="elementor-element elementor-element-136d7da elementor-widget elementor-widget-vt-ceremony_section_title">
																		<div class="elementor-widget-container">
																			<div class="section-title-wrap  crmny-sectTitleElementor ">
																				<h2 class="section-title mt-5">Add new Product</h2>
																			</div>
																		</div>
																	</div>
																	<div class="mx-auto col-md-8 elementor-element elementor-element-f13e9c0 elementor-widget elementor-widget-vt-ceremony_contact_form">
																		<div class="elementor-widget-container">
																			<div class="crmny-contact-form crmny-form crmny-formElementor">
																				<div class="screen-reader-response" role="alert" aria-live="polite"></div>
																				<form action="add-product.php" method="post" class="wpcf7-form init"  enctype="multipart/form-data">
																					<div class="crmny-rsvp">
																						<div class="form-content">
																							<div class="row">
																								<div class="col-md-12 namee">
																									<label>Choose Photo</label><br>
																									<span class="wpcf7-form-control-wrap purchaser_name"><input type="file" name="file" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" required></span>
																								</div>
																								<div class="col-md-6">
																									<label>Price</label><br>
																									<span class="wpcf7-form-control-wrap purchaser_email"><input type="number" name="price" min="0" max="9999" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required></span>
																								</div>
																								<div class="col-md-6">
																									<label>Price to Package</label><br>
																									<span class="wpcf7-form-control-wrap purchaser_email"><input type="number" name="pricePackage" min="0" max="9999" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email"></span>
																								</div>
																								<div class="col-md-12">
																									<br><label>Description</label><br>
																									<span class="wpcf7-form-control-wrap textarea-383"><textarea name="description" rows="5" class="wpcf7-form-control wpcf7-textarea" required></textarea></span>
																								</div>
																								<div class="crmny-rsvp-btn mx-auto">
																									<input type="submit" value="Add" class="wpcf7-form-control wpcf7-submit tribe-button tribe-button--rsvp">
																								</div>
																							</div>
																						</div>
																					</div>
																...
																<div class="elementor-widget-wrap">
																	<div class="elementor-element elementor-element-136d7da elementor-widget elementor-widget-vt-ceremony_section_title">
																		<div class="elementor-widget-container">
																			<div class="section-title-wrap  crmny-sectTitleElementor ">
																				<h2 class="section-title mt-5">Our Products</h2>
																			</div>
																		</div>
																	</div>
																	<div class="elementor-element elementor-element-f13e9c0 elementor-widget elementor-widget-vt-ceremony_contact_form">
																		<ul class="products columns-3">
																			<?php
																			$pro="SELECT * FROM products WHERE email='$email' ORDER BY id DESC";
																			...
																			<?php
																				...
																				while ($product=mysql_fetch_array($prod)) {?>
																					<li class="col-md-3 product type-product post-534 status-publish first instock product_cat-clothing product_cat-hoodies has-post-thumbnail shipping-taxable purchasable product-type-simple">
																						...
																						<div class="d-block">
																							<small class="d-block mt-2"><?php echo $product[2];?></small>
																						...
																						<span class="price">
																							...
																							<span class="woocommerce-Price-amount amount">
																								<span class="woocommerce-Price-currencySymbol"></span>
																								Package Price: <?php echo $product[4];?> JD
																							</span>
																							<br><br>
																						</span>
																						<a href="edit-product.php?id=<?php echo $product[0];?>" class="btn btn-primary">Edit</a>
																						<a href="delete-product.php?id=<?php echo $product[0];?>&img=<?php echo $product[1];?>" class="btn btn-danger">Delete</a>
																					</li>
																			<?php
																				}
																			}
