													...
													<div class="elementor-row">
														<div class="elementor-element elementor-element-2144465 elementor-column elementor-col-100 elementor-top-column" data-id="2144465" data-element_type="column">
															<div class="elementor-column-wrap  elementor-element-populated">
																...
																<?php
																if(isset($_SESSION['emailC'])) {
																	$cart="SELECT id,productID FROM cart WHERE email='$email' ORDER BY id DESC";
																	...
																	if(mysql_num_rows($cartIn) == 0) {?>
																		<div class="elementor-element elementor-element-136d7da elementor-widget elementor-widget-vt-ceremony_section_title" data-id="136d7da" data-element_type="widget" data-widget_type="vt-ceremony_section_title.default">
																			<div class="elementor-widget-container">
																				<div class="section-title-wrap  crmny-sectTitleElementor mt-5">
																	...
																	<?php
																		...
																		while($cartInfo=mysql_fetch_array($cartIn)) {
																			$prod="SELECT * FROM products WHERE id='$cartInfo[1]'";
																			...
																			<li class="col-md-3 product type-product post-534 status-publish first instock product_cat-clothing product_cat-hoodies has-post-thumbnail shipping-taxable purchasable product-type-simple">
																				...
																				<a href="delete-from-cart.php?id=<?php echo $cartInfo[0];?>" class="btn btn-danger">Delete</a>
																			</li>
																		<?php
																		}?>
																			</ul>
																			<div class="text-right position-relative">
																				<div id="search-4" class=" crmny-widget widget_search">
																					<form action="confirm.php" id="searchform" class="searchform no-icon" method="post">
																						<label class="align-baseline mr-2"><b>Wedding Date</b></label>
																						<input type="datetime-local" name="weddingDate" id="dateReserve" placeholder="dateReserve" />
																						<input type="submit" id="searchsubmit" class="submit-one hover-one" value="Confirm" />
																	...
																	<div class="elementor-element elementor-element-136d7da elementor-widget elementor-widget-vt-ceremony_section_title" data-id="136d7da" data-element_type="widget" data-widget_type="vt-ceremony_section_title.default">
																		<div class="elementor-widget-container">
																			...
																			<div class="section-title-wrap mt-5">
																				<p class="cart-empty woocommerce-info">You must log in to continue.</p>
																			</div>
                                                                            <br><br><br><br><br><br>
																		</div>
																	</div>
