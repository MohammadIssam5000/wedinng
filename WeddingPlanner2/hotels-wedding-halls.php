								...
								<div class="container crmny-content-area woo-col-3 crmny-right-sidebar">
									<div class="row">
										<div class="crmny-content-side crmny-primary">
											<h4>Hotels or Wedding Halls</h4>
											<div class="woocommerce-notices-wrapper"></div>
											<ul class="products columns-3">
												<?php
												extract($_GET);
												if($keywords == "") {
													$pro="SELECT * FROM products WHERE workField = 'Hotels or Wedding Halls' ORDER BY id DESC";
												} else {
													$pro="SELECT * FROM products WHERE workField = 'Hotels or Wedding Halls' AND description LIKE '%$keywords%' ORDER BY id DESC";
												}
