<?php
	...
	if(!isset($_SESSION['emailCom'])) {
		...
		$id = $_GET['id'];
		$pro="SELECT * FROM products WHERE email='$email' AND id='$id'";
								...
								<div class="crmny-header-right  mean-menu-parent">
									...
									<nav class="crmny-navigation" data-nav="1199">
										<ul id="menu-main-menu" class="">
											...
											<li id="menu-item-718" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-718 has-dropdown active">
												...
												<ul role="menu" class=" dropdown-nav">
													<li id="menu-item-1676" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1676 active">
														...
														<div class="elementor-element elementor-element-2144465 elementor-column elementor-col-100 elementor-top-column" data-id="2144465" data-element_type="column">
															<div class="elementor-column-wrap  elementor-element-populated">
																<div class="elementor-widget-wrap">
																	<div class="mx-auto col-md-8 elementor-element elementor-element-f13e9c0 elementor-widget elementor-widget-vt-ceremony_contact_form pt-5">
																		<div class="elementor-widget-container">
																			<div class="crmny-contact-form crmny-form crmny-formElementor">
																				<div class="screen-reader-response" role="alert" aria-live="polite"></div>
																				<form action="edit-info.php" method="post" class="wpcf7-form init">
																					...
																					<br><br><br><br><br>
																						<div class="form-content">
																							<div class="row">
																								<div class="col-md-4">
																									<label>Name</label><br>
																									<span class="wpcf7-form-control-wrap purchaser_email"><input type="text" name="name" value="<?php echo $name;?>" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required></span>
																								</div>
																								<div class="col-md-4">
																									<label>Phone</label><br>
																									<span class="wpcf7-form-control-wrap purchaser_email"><input type="tel" name="phone" value="<?php echo $phone;?>" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email"></span>
																								</div>
																								<div class="col-md-4">
																									<label>Address</label><br>
																									<span class="wpcf7-form-control-wrap purchaser_email"><input type="text" name="address" value="<?php echo $address;?>" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required></span>
																								</div>
																								<div class="crmny-rsvp-btn mx-auto">
																									<input type="submit" value="Save" class="wpcf7-form-control wpcf7-submit tribe-button tribe-button--rsvp">
																								</div>
