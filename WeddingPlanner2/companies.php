									...
									<nav class="crmny-navigation" data-nav="1199">
										<ul id="menu-main-menu" class="">
											<li id="menu-item-715" class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-715 active">
												<a href="companies.php" class="dropdown-toggle" aria-haspopup="true">
													<span class="menu-text"><span class="menu-text-wrap" data-hover="Companies">Companies</span></span>
												</a>
											</li>
											<li id="menu-item-327" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-327">
												<a href="customers.php">
													<span class="menu-text"><span class="menu-text-wrap" data-hover="Customers">Customers</span></span>
												</a>
											</li>
											<li id="menu-item-327" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-327">
												<a href="feedback.php">
													<span class="menu-text"><span class="menu-text-wrap" data-hover="Feedback">Feedback</span></span>
												</a>
											</li>
														...
														<div class="elementor-element elementor-element-2144465 elementor-column elementor-col-100 elementor-top-column" data-id="2144465" data-element_type="column">
															<div class="elementor-column-wrap  elementor-element-populated">
																<div class="elementor-widget-wrap">
																	<div class="mt-5 elementor-element elementor-element-f13e9c0 elementor-widget elementor-widget-vt-ceremony_contact_form">
																		<div class="table-responsive">
																			<table class="table table-hover">
																			<?php
																			$com="SELECT * FROM companies ORDER BY id DESC";
																			$comp=mysql_query($com, $db);
																			if (mysql_num_rows($comp) == 0) {?>
																				<div>
																					<p class="cart-empty woocommerce-info">There are no companies yet.</p>
																				</div>
																			<?php
																			} else {?>
																				<thead>
																				...
																				<?php
																				$counter=0;
																				while ($company=mysql_fetch_array($comp)) {
																					$counter++;?>
																					<tr>
																						<th scope="row"><?php echo $counter;?></th>
																						<td><?php echo $company[1];?></td>
																						<td><?php echo $company[2];?></td>
																						<td><?php echo $company[3];?></td>
																						<td><?php echo $company[4];?></td>
																						<td><?php echo $company[5];?></td>
																						<!-- if statement (compnay[7]==1)
																							else-->
																							<?php if ($company[7]==1){?>
																							<td><a href="delete-user.php?email=<?php echo $company[5];?>&target=companies&status=<?php echo $company[7];?>" class="btn btn-danger">Deactivte</a></td>
																							<?php } else { ?>
																							<td><a href="delete-user.php?email=<?php echo $company[5];?>&target=companies&status=<?php echo $company[7];?>" class="btn btn-danger">Activate</a></td>
																							<?php }?>
																					</tr>
																				<?php
																				}?>
