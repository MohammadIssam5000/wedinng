																...
																<div class="elementor-widget-wrap">
																	<div class="mt-5 elementor-element elementor-element-f13e9c0 elementor-widget elementor-widget-vt-ceremony_contact_form">
																		<div class="table-responsive">
																			...
																			<?php
																			$cust="SELECT * FROM customers ORDER BY id DESC";
																			$custom=mysql_query($cust, $db);
																			if (mysql_num_rows($custom) == 0) {?>
																				<div>
																					<p class="cart-empty woocommerce-info">There are no customers yet.</p>
																				</div>
																			<?php
																			} else {?>
																				<thead>
																				...
																				<?php
																				$counter=0;
																				while ($customer=mysql_fetch_array($custom)) {
																					$counter++;?>
																					<tr>
																						<!-- 3  / status 5 -->
																						...
																						<?php if ($customer[6]==1){?>
																						<td><a href="delete-user.php?email=<?php echo $customer[3];?>&target=customers&status=<?php echo $customer[6];?>" class="btn btn-danger">Deactivate</a></td>
																						<?php } else { ?>
																						<td><a href="delete-user.php?email=<?php echo $customer[3];?>&target=customers&status=<?php echo $customer[6];?>" class="btn btn-danger">Activate</a></td>
																						<?php }?>
																					</tr>
																				<?php
																				}?>
