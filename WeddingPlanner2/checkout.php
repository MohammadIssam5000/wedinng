				...
				<div class="crmny-topbar  hide-topbar-responsive">
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 top-right textright" style="">
								<div class="crmny-btn-wrap ">
									<a href="login.html"  class="crmny-btn"><i class="fa fa-sign-in"></i> Login</a>
								</div>
							</div>
						</div>
					</div>
										...
										<ul id="menu-main-menu" class="">
											...
											<li id="menu-item-718" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-718 has-dropdown active">
												...
												<ul role="menu" class=" dropdown-nav">
													...
													<li id="menu-item-575" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-575 active">
														<a href="checkout.php">
															<span class="menu-text"><span class="menu-text-wrap" data-hover="Checkout">Checkout</span></span>
														</a>
													</li>
													<?php echo $logout;?>
												</ul>
													...
													<div class="elementor-row">
														<div class="elementor-element elementor-element-2144465 elementor-column elementor-col-100 elementor-top-column" data-id="2144465" data-element_type="column">
															<div class="elementor-column-wrap  elementor-element-populated">
																...
																<?php
																if(isset($_SESSION['emailC'])) {
																	$cart="SELECT productID FROM cart WHERE email='$email' ORDER BY id DESC";
																	$cartIn=mysql_query($cart, $db);
																	if(mysql_num_rows($cartIn) == 0) {?>
																		<div class="elementor-element elementor-element-136d7da elementor-widget elementor-widget-vt-ceremony_section_title" data-id="136d7da" data-element_type="widget" data-widget_type="vt-ceremony_section_title.default">
																			<div class="elementor-widget-container">
																				<div class="section-title-wrap  crmny-sectTitleElementor ">
																					<h2 class="section-title mt-5">Your cart is empty.</h2>
																				</div>
																			</div>
																		</div>
																	<?php
																		...
																		<?php
																		while($cartInfo=mysql_fetch_array($cartIn)) {
																			$prod="SELECT * FROM products WHERE id='$cartInfo[0]'";
																	...
																	<div class="elementor-element elementor-element-136d7da elementor-widget elementor-widget-vt-ceremony_section_title" data-id="136d7da" data-element_type="widget" data-widget_type="vt-ceremony_section_title.default">
																		<div class="elementor-widget-container">
																			<div class="section-title-wrap">
																				<h2 class="section-title mt-5">You must log in to continue.</h2>
																			</div>
																		</div>
																	</div>
																<?php
