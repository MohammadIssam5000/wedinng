																	...
																	<div class="mx-auto col-md-8 elementor-element elementor-element-f13e9c0 elementor-widget elementor-widget-vt-ceremony_contact_form pt-5">
																		<div class="elementor-widget-container">
																			<div class="crmny-contact-form crmny-form crmny-formElementor">
																				...
																				<form action="edit-product-db.php" method="post" class="wpcf7-form init"  enctype="multipart/form-data">
																						...
																						<div class="form-content">
																							<div class="row">
																								<div class="col-md-6">
																									...
																									<span class="wpcf7-form-control-wrap purchaser_email"><input type="number" name="price" min="0" max="9999" value="<?php echo $product[3];?>" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required></span>
																								</div>
																								<div class="col-md-6">
																									<label>Price to Package</label><br>
																									<span class="wpcf7-form-control-wrap purchaser_email"><input type="number" name="pricePackage" min="0" max="9999" value="<?php echo $product[4];?>" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email"></span>
																								</div>
																								<div class="col-md-12">
																									<br><label>Description</label><br>
																									<span class="wpcf7-form-control-wrap textarea-383"><textarea name="description" rows="5" class="wpcf7-form-control wpcf7-textarea" required><?php echo $product[5];?></textarea></span>
																								</div>
