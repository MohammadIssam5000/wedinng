									...
									<div class="row">
										<div class="crmny-content-side crmny-primary">
											...
											<ul class="products columns-3">
												...
												extract($_GET);
												if($keywords == "") {
													$pro="SELECT * FROM products WHERE workField = 'Photoshoot' ORDER BY id DESC";
												} else {
													$pro="SELECT * FROM products WHERE workField = 'Photoshoot' AND description LIKE '%$keywords%' ORDER BY id DESC";
												}
