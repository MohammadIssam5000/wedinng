																...
																<div class="elementor-widget-wrap">
																	<div class="mt-5 elementor-element elementor-element-f13e9c0 elementor-widget elementor-widget-vt-ceremony_contact_form">
																		<div class="table-responsive">
																			...
																			$cont=mysql_query($con, $db);
																			if (mysql_num_rows($cont) == 0) {?>
																				<br><br><br><br>
																				<div>
																					<p class="cart-empty woocommerce-info">There are no feedback yet.</p>
																				</div>
                                                                                <br><br><br><br><br><br>
																			<?php
																			} else {?>
																				...
																				while ($contact=mysql_fetch_array($cont)) {
																					...
																					<tr>
																						...
																						<td><a href="delete-contact.php?id=<?php echo $contact[0];?>&email=<?php echo $contact[2];?>" class="btn btn-danger">Delete</a></td>
																					</tr>
																				<?php
																				}?>
																				</tbody>
